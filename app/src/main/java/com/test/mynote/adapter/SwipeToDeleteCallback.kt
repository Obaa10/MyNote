...
abstract class SwipeToDeleteCallback(val context: Context,val noteViewModel: NoteViewModel,val activity: MainActivity) :
    ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
    private val backgroundColor = Color.parseColor("#f44336")
    private val background = ColorDrawable()
    private var deleteIcon = ContextCompat.getDrawable(context, R.drawable.ic_baseline_check_24)!!
